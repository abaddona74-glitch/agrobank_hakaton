...
<main class="max-w-sm mx-auto my-8 flex flex-col gap-2">
  ...
  <form class="flex flex-col gap-2" on:submit|preventDefault={submit}>
    ...
    <div class="flex items-center gap-2">
      ...
      <button type="button" class="bg-secondary text-secondary-foreground shadow-xs hover:bg-secondary/80 rounded-md h-9 px-4"
